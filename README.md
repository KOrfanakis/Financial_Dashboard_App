...
Simply put, technical indicators are visual tools used by investors/traders to help them make investment choices. Technical indicators use historical data to interpret and forecast the future price action of a financial asset [[4](#resources)]. Together, these indicators form the basis of technical analysis [5].
...
Both indicators measure [momentum](https://www.investopedia.com/investing/momentum-and-relative-strength-index/) in a market. However, because they measure different factors, they sometimes give contrary indications [6].
...
- For creating and deploying the application:
  ...
  [1] [Get started](https://docs.streamlit.io/en/stable/getting_started.html) with Streamlit and [Gallery](https://streamlit.io/gallery?type=apps&category=finance-business) from the official website (Retrieved on Jun 16, 2021).
